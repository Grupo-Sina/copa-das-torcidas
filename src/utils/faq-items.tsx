...
export const faqItems = [
  {
    ...
    descriptions: [
      'É facin facin! É só você ficar ligado no Instagram @copadatorcidas que as missões são publicadas lá. Mas fica ligado que para poder ganhar, você tem que ter um cadastro na Esportes da Sorte.',
      <>
        E se você ainda não tiver um cadastro, não tem problema! Basta procurar
        o nome do seu time na aba "TIMES" aqui do site, clicar no link da sua
        torcida, fazer o cadastro rapidinho. E o melhor, fazendo isso é mais um
        jeito de você acumulara pontos para a sua torcida!
      </>,
    ],
  },
  {
